...
--
-- Class BlockedUser as table blocked_users
--
...
--
-- Class DeviceFingerprintRecord as table device_fingerprint_records
--
...
CREATE TABLE "driver_services" (
    ...
    "inquiryCount" bigint NOT NULL DEFAULT 0,
    "bookingCount" bigint NOT NULL DEFAULT 0,
...
--
-- Class MediaMetadata as table media_metadata
--
...
CREATE TABLE "orders" (
    ...
    "currencySymbol" text NOT NULL DEFAULT 'DH'::text,
...
--
-- Class ServiceAnalytics as table service_analytics
--
...
--
-- Class ServiceImage as table service_images
--
...
CREATE TABLE "service_requests" (
    ...
    "estimatedPurchaseCost" double precision,
    ...
    "isPurchaseRequired" boolean NOT NULL DEFAULT false,
    "shoppingList" json,
    "attachments" json,
    "catalogServiceId" bigint,
    "catalogDriverId" bigint,
    "notes" text,
    "clientName" text NOT NULL,
    "clientPhone" text,
    "driverName" text,
    "driverPhone" text,
    "proposedDriverName" text,
    "proposedDriverPhone" text,
    "cancelledBy" bigint,
    "cancellationReason" text,
...
--
-- Class StoreCategory as table store_categories
--
...
--
-- Class StoreDeliveryRequest as table store_delivery_requests
--
...
--
-- Class StoreOrderChatMessage as table store_order_chat_messages
--
...
--
-- Class StoreOrderChat as table store_order_chats
--
...
--
-- Class StoreOrderItem as table store_order_items
--
...
--
-- Class StoreOrder as table store_orders
--
...
--
-- Class StoreProduct as table store_products
--
...
--
-- Class StoreReport as table store_reports
--
...
--
-- Class StoreReview as table store_reviews
--
...
CREATE TABLE "transactions" (
    ...
    "exchangeRateToBase" double precision NOT NULL DEFAULT 1.0,
    "vatRate" double precision NOT NULL DEFAULT 0.0,
...
CREATE TABLE "users" (
    ...
    "totalTrips" bigint NOT NULL DEFAULT 0,
    ...
    "trustScore" double precision DEFAULT 0.0,
    "trustLevel" text DEFAULT 'FAIR'::text,
    "trustScoreUpdatedAt" timestamp without time zone,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Foreign relations for "blocked_users" table
--
...
--
-- Foreign relations for "media_metadata" table
--
...
--
-- Foreign relations for "service_analytics" table
--
...
--
-- Foreign relations for "service_images" table
--
...
--
-- Foreign relations for "store_delivery_requests" table
--
...
--
-- Foreign relations for "store_order_chat_messages" table
--
...
--
-- Foreign relations for "store_order_chats" table
--
...
--
-- Foreign relations for "store_order_items" table
--
...
--
-- Foreign relations for "store_orders" table
--
...
--
-- Foreign relations for "store_products" table
--
...
--
-- Foreign relations for "store_reports" table
--
...
--
-- Foreign relations for "store_reviews" table
--
...
--
-- Foreign relations for "stores" table
--
...
--
-- Foreign relations for "user_notifications" table
--
