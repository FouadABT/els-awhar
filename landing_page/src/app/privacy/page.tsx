...
export default function PrivacyPage() {
  ...
  const sections = [
    { key: 'collection', ...t.privacy.sections.collection },
    { key: 'usage', ...t.privacy.sections.usage },
    { key: 'sharing', ...t.privacy.sections.sharing },
    { key: 'security', ...t.privacy.sections.security },
    { key: 'rights', ...t.privacy.sections.rights },
      ...
      <main className="flex-1 pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className={isDark ? 'text-gray-400' : 'text-gray-500'}>{t.privacy.lastUpdated}</p>
          </div>

          {/* Intro */}
          <div className={`border-l-4 border-amber-500 p-6 rounded-r-lg mb-8 ${isDark ? 'bg-amber-900/20' : 'bg-amber-50'}`}>
            <p className={`leading-relaxed ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>{t.privacy.intro}</p>
          </div>
